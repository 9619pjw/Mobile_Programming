...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NavigationUI.setupActionBarWithNavController(
            ...
            AppBarConfiguration.Builder(R.id.splashFragment, R.id.loginFragment,
                R.id.searchFragment, R.id.userFragment).build()
        )
    ...
    // AppBar(툴바)에서 뒤로가기 버튼(<-) 눌렀을 때, 뒤로 이동하려면 onSupportNavigateUp를 오버라이드하여 구현
