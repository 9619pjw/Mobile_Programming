...
object NetworkModule {
    ...
    */
    ...
    /* HttpUrl 객체 정의 함수 선언
       ...
       - Open API 명세에 맞춰 선언
    */
    fun makeHttpUrl(scode: String, date: String, amount: String): HttpUrl { // http://211.237.50.150:7080/openapi/
        return HttpUrl.Builder() // HttpUrl 객체 정의
            .scheme("http")
            .host("211.237.50.150")
            .port(7080)
