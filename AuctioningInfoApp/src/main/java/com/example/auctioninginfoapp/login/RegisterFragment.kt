...
class RegisterFragment : Fragment() {
    ...
    ): View? { // fragment_register 뷰 inflate
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /* 가입하기 버튼을 클릭한 경우 */
        binding.btnRegister.setOnClickListener { //id, pw, pw_firm 값 가져오기
            ...
            when {
                ...
                pw_firm != pw ->
                ...
                else -> { //id, pw, pw_firm 입력값이 정상이면, 로딩 창 띄워줌
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(id, pw)
                        .addOnCompleteListener { task ->
                            task.addOnSuccessListener { //성공한 경우, 입력 필드 초기화
