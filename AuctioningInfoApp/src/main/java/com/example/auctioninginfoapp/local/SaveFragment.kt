...
// DB에 저장된 검색 결과를 클릭하면 리사이클러 뷰에 표시
class SaveFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 리사이클러 뷰에 어댑터 및 LayoutManager 설정
        ...
        arguments?.getLong("SAVE_ID")?.let { saveId ->
            ...
            val pagingData = Pager(
                PagingConfig(20), 1,
                // DB(FreshData)에서 데이터를 퀴리하여 PagingSource(DataSource) 객체로 반환함.
            ...
            pagingData.liveData.observe(viewLifecycleOwner) {
                ...
                */
                lifecycleScope.launch { saveAdapter.submitData(it) } // 코루틴 스코프
            }
        }
